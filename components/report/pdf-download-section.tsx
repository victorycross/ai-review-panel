    ...
    >
      {({ loading, error }) => (
        <button
          ...
          className="inline-flex items-center gap-2 rounded-md border border-border bg-surface hover:bg-surface-2 disabled:opacity-50 disabled:cursor-not-allowed px-4 py-2 text-sm text-neutral-200 transition-colors"
        >
